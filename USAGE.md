# Guild Availability Management System (GAMS) - Usage & Installation Guide
...
The **Guild Availability Management System (GAMS)** is a full-stack MERN (MongoDB, Express, React, Node.js) application. It operates on a client-server model:
- **Backend (Server):** An Express/Mongoose API that handles data, business logic, and MongoDB communication.
- **Frontend (Client):** A React application that provides the user interface for browsing artifacts, accepting guild contracts, and managing reservations.

This guide explains how to set up, run, and test both the backend and frontend simultaneously for local development.
...
```bash
# Clone the backend (Assessment 2)
git clone <https://github.com/lorenaborges256/DEV1003_A2_BackEnd_GAMS>

# Clone the frontend (Assessment 3)
